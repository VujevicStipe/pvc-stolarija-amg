export const meta = {
  ...
  keywords: 'PVC stolarija Split, PVC prozori Split, PVC vrata, montaža prozora, Kaštela, Dalmacija',
  author: 'AMG PVC Stolarija',
  company: {
    name: 'AMG PVC Stolarija',
    legalName: 'AMG Obrt za proizvodnju PVC stolarije',
    address: {
      street: 'Ulica Sv. Jurja 74',
      city: 'Kaštel Stari',
      region: 'Dalmacija',
      postalCode: '21217',
      country: 'Croatia',
